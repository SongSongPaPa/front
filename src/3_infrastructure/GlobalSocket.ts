...
class GlobalSocket {
  ...
  private static chatSocket = io(`${process.env.REACT_APP_SOCKET_URL as string}/chat1`, {
    withCredentials: true,
  });
  private static userSocket = io(`${process.env.REACT_APP_SOCKET_URL as string}/user1`, {
    withCredentials: true,
  });
